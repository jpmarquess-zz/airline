...
<!-- 		<script src="http://cdn.ckeditor.com/4.13.1/standard/ckeditor.js"></script> -->
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item active">
            <a class="nav-link" href="<?php echo base_url(); ?>voos">Voo <span class="sr-only">(current)</span></a>
          </li>
        </ul>
    ...
    <?php if($this->session->flashdata('voo_deleted')) : ?>
      <?php echo '<p class="alert alert-success">'.$this->session->flashdata('voo_deleted').'</p>'; ?>
    <?php endif; ?>